...
class StandardRoIHead(BaseRoIHead):
    ...
    def loss(self, x: Tuple[Tensor], rpn_results_list: InstanceList,
        ...
        if self.with_bbox:
            ...
            # print('bbox_results', bbox_results.keys())
            losses.update({'loss_cls':bbox_results['loss_cls'], 'loss_bbox':bbox_results['loss_bbox']})
    ...
    def bbox_loss(self, x: Tuple[Tensor],
        ...
        # print('bbox_loss_and_target', bbox_loss_and_target)
        bbox_results.update(bbox_loss_and_target) # (loss_bbox=bbox_loss_and_target['loss_bbox'])
        return bbox_results
